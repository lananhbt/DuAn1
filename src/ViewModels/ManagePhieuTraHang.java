...
public class ManagePhieuTraHang {
    private String maHD;
    private String maKH;
    private String  maND ;
    ...
    public ManagePhieuTraHang() {
    }

    public ManagePhieuTraHang(String maHD, String maKH, String maND, String maPTH, Date ngayTra, double tienTraLaiKhach, String lyDoTra) {
        this.maHD = maHD;
        this.maKH = maKH;
        this.maND = maND;
        this.maPTH = maPTH;
